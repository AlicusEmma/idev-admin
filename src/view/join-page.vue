<template>
  <div>
    <Row :gutter="20">
      <i-col span="12">
        <Card title="iDev-admin交流群(已满)" shadow>
          <img class="qq-group-img" :src="qqFans" alt="">
          <p class="qq-group-intro">本群为使用iDev-admin或者对iDev-admin感兴趣的开发者提供交流平台，在这里，解决你开发中的疑惑，共同进步。</p>
        </Card>
      </i-col>
      <i-col span="12">
        <Card title="iDev-admin交流群2" shadow>
